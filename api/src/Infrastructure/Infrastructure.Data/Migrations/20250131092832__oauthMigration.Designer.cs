...
namespace Homemap.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250131092832__oauthMigration")]
    partial class _oauthMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Homemap.ApplicationCore.Models.Auth.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Homemap.ApplicationCore.Models.Auth.UserSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Homemap.ApplicationCore.Models.Auth.UserSession", b =>
                {
                    b.HasOne("Homemap.ApplicationCore.Models.Auth.User", "User")
                        .WithMany("Sessions")
